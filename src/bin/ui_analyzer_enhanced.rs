...
fn main() {
    ...
    let critical_missing =
        analyzer.get_features_by_status_and_priority(FeatureStatus::Missing, Priority::Critical);
    let high_missing =
        analyzer.get_features_by_status_and_priority(FeatureStatus::Missing, Priority::High);
    let broken_critical =
        analyzer.get_features_by_status_and_priority(FeatureStatus::Broken, Priority::Critical);
