...
impl VisualLanguageBridge {
                ...
                let error_strings: Vec<String> = errors
                    ...
                    .map(|e| {
                        format!(
                            "{}: {}",
                            e.node_id
                                .map_or("Graph".to_string(), |id| format!("Node({})", id.0)),
                            e.message
                        )
                    })
                    .collect();
    ...
    pub fn is_equivalent_after_round_trip(
        &mut self,
        original_graph: &NodeGraph,
        ...
        Ok(original_graph.nodes.len() == new_graph.nodes.len()
...
mod tests {
    ...
    fn test_round_trip_conversion() {
        ...
        assert_eq!(
            original_graph.connections.len(),
