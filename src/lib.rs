...
/// SuperInstance infrastructure layer for deterministic shader compilation,
/// budget enforcement, and agent coordination
pub mod superinstance;

/// Control Engine — prime-structured scheduling + complex-valued signal processing
/// Acts as a higher-level orchestration layer over SuperInstance.
/// Runs in Rust host, pipes to WGSL via uniforms/buffers — not compiled into shaders.
