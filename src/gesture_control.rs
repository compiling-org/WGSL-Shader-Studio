...
impl GestureControlSystem {
    ...
    pub fn update(&mut self) {
        ...
        self.gesture_history
            .retain(|(_, timestamp)| now.duration_since(*timestamp).as_secs_f32() < 5.0);
    ...
    fn calculate_palm_velocity(&self, _hand_id: u32) -> (f32, f32, f32) {
...
mod tests {
    ...
    fn test_gesture_simulation() {
        ...
        assert!(gesture_system
            .get_active_gestures()
            .contains_key(&GestureType::HandOpen));
        assert_eq!(
            gesture_system.get_active_gestures()[&GestureType::HandOpen],
            0.8
        );
    }
